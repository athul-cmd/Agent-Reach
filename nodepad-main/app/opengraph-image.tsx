...
export const alt = "Content Research Studio — continuous research workspace"
    ...
    (
      ...
      >
        ...
        >
          Track your niche.
          <br />
          <span style={{ color: "#3ecf6e" }}>Turn signals into weekly ideas.</span>
        </div>

        <div style={{ fontSize: 24, color: "#666", fontWeight: 400, letterSpacing: "-0.3px" }}>
          Supabase-backed research workspace
        </div>
      </div>
    ),
    { ...size },
